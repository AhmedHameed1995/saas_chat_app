                            ...
                            <OrganizationSwitcher 
                                ...
                                appearance={{
                                    elements: {
                                        ...
                                        organizationPreview: "group-data-[collapisible=icon]:justify-center! gap-2!",
                                        organizationPreviewTextContainer: "group-data-[collapisible=icon]:hidden! text-xs! font-medium! text-sidebar-foreground",
                                        organizationSwitcherTriggerIcon: "group-data-[collapisible=icon]:hidden! ml-auto! text-sidebar-foreground",
                                    },
                                }} 
                            />                            
                        </SidebarMenuButton>
